...
public class BitmapContentUriTaskTest extends RobolectricTest {
    ...
    public void testGetFromUri() {
        ...
        Mockito.when(request.uri()).thenReturn(Uri.parse("content://some/content/image.jpg"));
        ...
        BitmapContentUriTask task = new BitmapContentUriTask(
                RuntimeEnvironment.application, null, request, manager, callback);
    ...
    @Test
    public void testGetFromUri_saveSource() {
